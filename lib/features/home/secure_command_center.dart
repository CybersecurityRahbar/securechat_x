  ...
  Widget build(BuildContext context) => const SecureChatCard(
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: SecureChatSpace.lg),
        _StateLine(label: 'Local persistence', value: 'Foundation only'),
        _StateLine(label: 'Network transport', value: 'Interface only'),
        _StateLine(label: 'Cryptographic engine', value: 'Interface only'),
        _StateLine(label: 'Diagnostics', value: 'Redacted boundary active'),
      ],
    ),
  );
}
